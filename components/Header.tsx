...
function Home() {
  ...
  return (
    <div
      className={clsx(
        "group rounded-full bg-white/90 px-4 py-1 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20",
      )}
    >
      <Link
        href="/"
